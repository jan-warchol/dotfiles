...
bind -x '"\C-o\C-d": FZF_CTRL_T_COMMAND="GIT_DIR=~/.dotfiles.git git ls-files | sed s:^:$HOME/:; find -L ~/.ssh; find ~/.fzf/shell; find ~/.config/xkb -name .git -prune -o -print" fzf-file-widget'
